...
\usepackage[textwidth=7.25in,textheight=10.1in]{geometry}
...
\begin{document}
\sffamily
{ \begin{center}\huge \textsc{\textbf{Benjamin Tannenwald}} \\\vspace{1mm}\fontsize{12}{13}\selectfont \sc Columbus, OH\end{center}}%\vspace*{.02in}}
\vspace{-4mm}
